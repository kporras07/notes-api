 ...
 */
class Version20180321033210 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE note ADD title VARCHAR(255) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE note DROP title, CHANGE user_id user_id INT DEFAULT NULL');
    }
}
